...
public class HommeService implements IDao<Homme> {
    ...
    public void displayGetWives(int idHomme, Date dateDebut, Date dateFin) throws ParseException {
        ...
        if (wives.isEmpty()) {
            System.out.println("lonely man!");
        } else {
            System.out.println("this man has ");
            for (Femme femme : wives) {
                System.out.println(femme.getNom() +" "+ femme.getPrenom() +" as a wife");
            }
        }
    }
...
public void displayAllMarriagesOfMan(int hommeId) {
    ...
    try {
        ...
        if (homme != null) {
            ...
            if (!mariages.isEmpty()) {
                System.out.println("this man has been married :");
                int mariageEnCoursCount = 1;
                int mariageEchoueCount = 1;
                System.out.println("current marraiges :");
                for (Mariage mariage : mariages) {
                ...
                System.out.println("this man is on the talking stage");
            }
        } else {
