...
public class ProjetService  implements IDao<Projet> {
    ...
    public void afficherTachesPlanifieesProjet(int projetId) {
        ...
        if (tachesPlanifiees.isEmpty()) {
            System.out.println("Aucune tache planifiee pour " + projetId);
        } else {
        ...
        if (tachesRealisees.isEmpty()) {
            ...
            for (Tache tache : tachesRealisees) {
                ...
                if (!employeTaches.isEmpty()) {
                    ...
                    System.out.printf("%-4d %-15s %-18s %-18s%n",num,tache.getNom(),employeTache.getId().getDateDebut(),employeTache.getId().getDateFin());
                    num++;
                }
            }
        }
