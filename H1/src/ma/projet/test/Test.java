...
/*
       Produit p1 = new Produit("kwasaki","h2r",new Date(),10,"des1");
       p.create(p1);
       Produit p2 = new Produit("yamaha","r1",new Date(),20,"des2");
       p.create(p2);
       Produit p3 = new Produit("ducati","v4",new Date(),30,"des3");
       p.create(p3);
       Produit p4 = new Produit("honda","600cc",new Date(),40,"des4");
       p.create(p4);
       Produit p5 = new Produit("aprelia","1050cc",new Date(),50,"des5");
       p.create(p5);
*/
